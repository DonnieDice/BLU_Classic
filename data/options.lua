...
BLU.defaults = {
    profile = {
        ...
        AchievementSoundSelect = "palworld",
        AchievementVolume = 2.0,
        BattlePetLevelSoundSelect = "pokemon",
        BattlePetLevelVolume = 2.0,
        DelveLevelUpSoundSelect = "shining_force_3_11",
        DelveLevelUpVolume = 2.0,
        HonorSoundSelect = "league_of_legends",
        HonorVolume = 2.0,
        LevelSoundSelect = "kingdom_hearts_3",
        LevelVolume = 2.0,
        PostSoundSelect = "warcraft_3_1",
        PostVolume = 2.0,
        QuestAcceptSoundSelect = "kirby_2",
        QuestAcceptVolume = 2.0,
        QuestSoundSelect = "kirby_1",
        QuestVolume = 2.0,
        RenownSoundSelect = "fly_for_fun",
        RenownVolume = 2.0,
        RepSoundSelect = "everquest",
        RepVolume = 2.0,
    },
}
